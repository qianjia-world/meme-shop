          ...
          <div class="col-sm-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="image"
                      placeholder="請輸入圖片連結" v-model="good.imageUrl">
            </div>
            <div class="mb-3">
          ...
          <div class="col-sm-8">
            ...
            <div class="row gx-2">
              <div class="mb-3 col-md-6">
                ...
                <input type="text" class="form-control" id="category"
                        placeholder="請輸入分類" v-model="good.category">
              </div>
              <div class="mb-3 col-md-6">
                <label for="price" class="form-label">單位</label>
                <input type="text" class="form-control" id="unit"
                        placeholder="請輸入單位" v-model="good.unit">
              </div>
            </div>
            ...
            <div class="row gx-2">
              <div class="mb-3 col-md-6">
                ...
                <input type="number" class="form-control" id="origin_price"
                        placeholder="請輸入原價" v-model="good.origin_price">
              </div>
              <div class="mb-3 col-md-6">
                <label for="price" class="form-label">售價</label>
                <input type="number" class="form-control" id="price"
                        placeholder="請輸入售價" v-model="good.price">
              </div>
            </div>
            <hr>
            ...
            <div class="mb-3">
              ...
              <textarea type="text" class="form-control" id="description"
                        placeholder="請輸入產品描述" v-model="good.description"></textarea>
            </div>
            <div class="mb-3">
